...
CoordSystemSample::~CoordSystemSample() noexcept {
...
void CoordSystemSample::Init() {
    ...
    if (m_ProgramObj) {
        ...
        LOGCATE("CoordSystemSample::Init create program failed");
    }
...
void CoordSystemSample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    LOGCATD("CoordSystemSample::UpdateMVPMatrix angleX = %d, angleY = %d, ratio = %f", angleX, angleY, ratio);
    angleX = angleX % 360;
    angleY = angleY % 360;
    //转化为弧度角
...
//    glm::mat4 Projection = glm::frustum(-ratio, ratio, -1.0f, 1.0f, 4.0f, 100.0f);
    ...
    glm::mat4 View = glm::lookAt(
                ...
                glm::vec3(0, 0, 0),//and looks at the original
...
void CoordSystemSample::UpdateTransformMatrix(float rotateX, float rotateY, float scaleX, float scaleY) {
    SampleBase::UpdateTransformMatrix(rotateX, rotateY, scaleX, scaleY);
