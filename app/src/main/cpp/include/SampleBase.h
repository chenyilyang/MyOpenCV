...
#define SAMPLE_SHADER_TYPE_YUVTEXTURE 4
#define SAMPLE_SHADER_TYPE_VAOVBO 5
#define SAMPLE_SHADER_TYPE_TRANSFORM_FEEDBACK 6
#define SAMPLE_SHADER_TYPE_COORD_SYSTEM 7
