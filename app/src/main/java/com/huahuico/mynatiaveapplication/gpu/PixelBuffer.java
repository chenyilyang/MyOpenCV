...
package com.huahuico.mynatiaveapplication.gpu;
...
//        mEGL.eglMakeCurrent(mEGLDisplay, mEGLSurface, mEGLSurface, mEGLContext);
        //make no surface
        mEGL.eglMakeCurrent(mEGLDisplay, EGL_NO_SURFACE, EGL_NO_SURFACE, mEGLContext);
    ...
    public void setRenderer(final GLSurfaceView.Renderer renderer) {
        ...
        if (!Thread.currentThread().getName().equals(mThreadOwner)) {
            android.util.Log.e(TAG, "setRenderer: This thread does not own the OpenGL context.");
            return;
        }
    ...
    public Bitmap getBitmap() {
        ...
        if (mRenderer == null) {
            android.util.Log.e(TAG, "getBitmap: Renderer was not set.");
            return null;
        }

        // Does this thread own the OpenGL context?
        if (!Thread.currentThread().getName().equals(mThreadOwner)) {
            android.util.Log.e(TAG, "getBitmap: This thread does not own the OpenGL context.");
            return null;
        }
    ...
    private void listConfig() {
        android.util.Log.i(TAG, "Config List {");
        ...
        for (EGLConfig config : mEGLConfigs) {
            ...
            android.util.Log.i(TAG, "    <d,s,r,g,b,a> = <" + d + "," + s + "," +
                    r + "," + g + "," + b + "," + a + ">");
        }
