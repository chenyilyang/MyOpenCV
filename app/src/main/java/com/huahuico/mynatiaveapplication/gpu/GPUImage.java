...
public class GPUImage {
    ...
    private String getPath(final Uri uri) {
        ...
        android.database.Cursor cursor = mContext.getContentResolver()
    ...
    public static void getBitmapForMultipleFilters(final Bitmap bitmap,
                                                   final java.util.List<GPUImageFilter> filters, final ResponseListener<Bitmap> listener) {
        if (filters.isEmpty()) {
            return;
        }
    ...
    private class LoadImageUriTask extends LoadImageTask {
        ...
        protected Bitmap decode(BitmapFactory.Options options) {
            try {
                ...
                if (mUri.getScheme().startsWith("http") || mUri.getScheme().startsWith("https")) {
                    inputStream = new java.net.URL(mUri.toString()).openStream();
                } else {
        ...
        protected int getImageOrientation() throws IOException {
            android.database.Cursor cursor = mContext.getContentResolver().query(mUri,
